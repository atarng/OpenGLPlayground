...
quat QuaternionWrapper::RotationBetweenVectors(vec3 start, vec3 dest) {
 ...
 */
quat QuaternionWrapper::LookAt(vec3 direction, vec3 desiredUp) {
 ...
 */
quat QuaternionWrapper::RotateTowards(quat q1, quat q2, float maxAngle) {
    if (maxAngle < 0.001f) {
